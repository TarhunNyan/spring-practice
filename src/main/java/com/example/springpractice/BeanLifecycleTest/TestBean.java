...
public class TestBean implements InitializingBean,
	...
	public void destroy( ) throws
	                       Exception {
		System.out.println("TestBean: запущен destroy, " +
				                   "имплементированный от DisposableBean");
	}
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		System.out.println("TestBean: запущен onApplicationEvent, " + "имплементированный от ApplicationListener<ContextRefreshedEvent>");
	}
	...
	public void destroyConfigMethod( ) {
		System.out.println("TestBean: запущен метод прописанный в " +
				                   "Configuration как destroy-метод");
	}
